...
public class TodoDatabase extends SQLiteOpenHelper {
    ...
    public static TodoDatabase getInstance(Context context){
            if (instance == null){
                instance = new TodoDatabase(context, "table", null, 1 );
            }
            return instance;
    }
...
//        contentValues.put(title, completed);
//
...
//        ContentValues contentValues = new ContentValues();
//        String boolean_key = id.toString();
//        contentValues.put(boolean_key, completed);
//
//        // Then call update() on the database.
//        // Tip: use the whereClause to specify which record you want to update: "_id = " + id.
//        db.update("table", contentValues, "_id = " + id, null);
//
